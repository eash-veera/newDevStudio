window.devportal.partials.create = function($scope, $dev, $auth, $state, $fileReader){
	...
	$scope.steps = [
		{
			templateUrl: 'views/partials/create/step-form_project_type.html',
			title: 'Project Type'
		},
		{
			templateUrl: 'views/partials/create/step-form_project_detail.html',
			title: 'Project Details'
		},
		{
			templateUrl: 'views/partials/create/step-form_project_documentation.html',
			title: 'Project Documentation'
		},
		{
			templateUrl: 'views/partials/create/step-form_project_initaition.html',
			title: 'Initiate Project'
		}
	];

	//initial hidden variable
	$scope.typeOptionSelect = false;
