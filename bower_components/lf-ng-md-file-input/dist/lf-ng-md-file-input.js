            ...
            template:  ['<div layout="column" class="lf-ng-md-file-input">',
                            ...
                            '<div layout="row" class="lf-ng-md-file-input-container" >',
                                '<div class="lf-ng-md-file-input-caption" layout="row" layout-align="start center" flex ng-class="{\'disabled\':isDisabled}" >',
                                    '<md-icon md-svg-icon="icons/ic_insert_drive_file_24px.svg" style="fill:rgba(100,100,100,1);"></md-icon>',
                                    '<div flex class="lf-ng-md-file-input-caption-text-default" ng-show="isFilesNull" style="color:rgba(100,100,100,1);">',
                                ...
                                '<md-button ng-disabled="isDisabled" ng-click="removeAllFiles()" ng-hide="isFilesNull" class="md-raised lf-ng-md-file-input-button lf-ng-md-file-input-button-remove" >',
                                    '<md-icon md-svg-icon="icons/ic_clear_24px.svg" style="fill:rgba(100,100,100,1);"></md-icon> ',
                                '</md-button>',
                                '<md-button ng-disabled="isDisabled" ng-click="openDialog($event, this)" class="md-raised md-accent lf-ng-md-file-input-button lf-ng-md-file-input-button-brower" style="color:#fff;">',
                                    '<md-icon md-svg-icon="icons/ic_file_upload_24px.svg" style="fill:#fff; margin-right:5px;"></md-icon>',
                                    '{{strCaptionBrowse}}',
